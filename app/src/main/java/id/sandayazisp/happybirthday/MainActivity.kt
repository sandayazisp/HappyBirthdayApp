package id.sandayazisp.happybirthday
...
import id.sandayazisp.happybirthday.ui.theme.HappyBirthdayTheme
...
fun BirthdayCardPreview() {
    HappyBirthdayTheme {
        BirthdayGreetingWithImage( "Happy Birthday Sanday!", "- from Fatin")
    }
}